...
connect = () => {
//checks if empty 
  var fed=this; //with the help of var you can use gloabby inside a function. 
...
}//checks if card exits or not. this is to reduce duplication 
else{
    var Id= firebase.auth().currentUser.uid; //every user has ID generated by firebase 
  
  // LINE 31-41 checks is users exist or not
   firebase.database().ref('Card/'+this.state.cc).once('value',function (snapshot){ //
     ...
     }else{ //this updates the data

      firebase.database().ref('User/'+Id+'/').update({
        cc:fed.state.cc,
      });
        //structure on how to set data inside firebade
...
//sql and no sql. you can make changes realtime and sql you cannot. 
...
<ScrollView>
        ...
        >
            <Text style = {styles.connect}>
               Connect //when clicked this button 
            </Text>
         </TouchableOpacity>
          </View>
          </ScrollView>
